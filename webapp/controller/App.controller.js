sap.ui.define([
	...
	return Controller.extend("sap.ui.bootcamp.controller.App", {
		onLoginPress: function(){
				...
				// var oUsername = this.getView().byId("pword").getValue(); 
				...
				// | oPassword.length === 0)
					...
					// else
					// {
					// 		sap.m.MessageToast.show("Hello Pilipins login successful");
					// }
		} , 
		...
		onInit: function(){
			...
			var i18nModel = new ResourceModel(
				{
					// bundleUrl: "sap.ui.bootcamp.i18n.i18n", // string
